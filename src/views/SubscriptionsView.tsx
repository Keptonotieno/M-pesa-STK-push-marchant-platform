          ...
          <div className="block md:hidden divide-y divide-slate-100 dark:divide-slate-800">
            {filteredInvoices.length === 0 ? (
              ...
              filteredInvoices.map((inv) => (
                <div key={inv.id} className="p-4 space-y-3 hover:bg-slate-50/50 dark:hover:bg-slate-950/50 transition">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <span className="mt-0.5 inline-block">
                        ...
                        {inv.status === 'FAILED' && (
                          <span className="px-2 py-0.5 rounded-full bg-rose-500/15 text-rose-600 dark:text-rose-400 text-[10px] font-bold">
                            ● FAILED
                          </span>
                        )}
                      </span>
                  ...
                  <div className="flex items-center justify-between text-xs pt-1 border-t border-slate-100 dark:border-slate-800/60 text-slate-500 dark:text-slate-400">
                    <span className="font-mono text-[10px]">
                      {inv.mpesaReceipt ? `Receipt: ${inv.mpesaReceipt}` : inv.paymentMethod || 'M-PESA STK Push'}
                    </span>
                  ...
                  <div className="flex justify-end pt-1">
                    <button
                      ...
                      className="px-3 py-2 min-h-[36px] rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs transition flex items-center gap-1.5 cursor-pointer"
                    >
